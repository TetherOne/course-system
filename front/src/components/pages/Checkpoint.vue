...
<!--        async loadData() {-->
<!--            try {-->
<!--                const checkpoint = await API_URL.checkpoint(this.id);-->
...
<!--        async alreadyPassed() {-->
<!--            try {-->
<!--                const result = await API_URL.didStudentPassCheckpoint(this.user.id, this.id);-->
<!--                return result;-->
<!--            } catch (error) {-->
...
<!--            try {-->
<!--                await axios.post(`${API_URL.passedCheckpointsAPI}/`, {-->
...
<!--                for (const question of this.questions) {-->
<!--                    await axios.post(`${API_URL.historyOfPassedAnswersAPI}/`, {-->
<!--                        student: this.user.id,-->
<!--                        checkpoint: this.id,-->
...
<!--        if (this.passed) {-->
<!--            const checkpoint = await API_URL.studentCheckpointResult(this.user.id, this.id);-->
