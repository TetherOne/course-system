<!--<script>-->
<!--import { API_URL } from '#classes/API';-->
...
<!--        async loadData() {-->
<!--            try {-->
<!--                const course = await API_URL.course(this.id);-->
...
<!--                try {-->
<!--                    this.modules = await API_URL.courseModules(this.id);-->
...
<!--                    try {-->
<!--                        const teacher = await API_URL.teacher(this.teacherId);-->
...
<!--            try {-->
<!--                const lessons = await API_URL.moduleLessons(moduleId);-->
<!--                return lessons;-->
<!--            } catch (error) {-->
...
<!--            for (const module of this.modules) {-->
<!--                try {-->
<!--                    module.checkpoints = await API_URL.moduleCheckpoints(module.id);-->
<!--                } catch (error) {-->
...
<!--            try {-->
<!--                await API_URL.addModule(this.newModule.name, this.id);-->
<!--                this.$router.go();-->
<!--            } catch (error) {-->
...
<!--            try {-->
<!--                await API_URL.addLesson(moduleId, module.newLesson.name, module.newLesson.description);-->
<!--                this.$router.go();-->
<!--            } catch (error) {-->
